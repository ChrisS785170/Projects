...
parser = argparse.ArgumentParser(
    ...
    epilog=
        ...
        "(Software Engineering Project 2024, Semester 2) using the provided\n"
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    command_line_for_reference_implementation = [
        "cmd.exe",
        "/c",
        r"2024_block_coalescing_reference_implementation.exe",
        "<", args.path_to_block_model_input_csv,
...
print("compression: {}".format(compression), file=stdout)
if args.speed:
    print("speed: {}".format(speed), file=stdout)
